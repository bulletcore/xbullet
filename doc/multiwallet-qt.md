...
Only requiring some minor changes is bullet.cpp.
...
Changes to bullet.cpp
----------------------
bullet.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
