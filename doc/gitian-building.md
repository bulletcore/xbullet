...
git clone https://github.com/bulletpay/bullet
```
...
```bash
    ...
    From https://github.com/bulletpay/bullet
...
[bullet/gitian.sigs](https://github.com/bulletpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
