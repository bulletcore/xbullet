...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BulletNetwork") type = BulletNetwork;
    if(strType == "BulletNetworkVariable") type = BulletNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BulletNetwork) s = "BulletNetwork";
    if(type == BulletNetworkVariable) s = "BulletNetworkVariable";
