...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Bullet: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Bullet: 2.5 minutes
        ...
        vSeeds.push_back(CDNSSeedData("bullet.org", "dnsseed.bullet.org"));
        vSeeds.push_back(CDNSSeedData("bulletdot.io", "dnsseed.bulletdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("bulletpay.io", "dnsseed.bulletpay.io"));

        // Bullet addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Bullet script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Bullet private keys start with '7' or 'X'
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("bulletdot.io",  "testnet-seed.bulletdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "test.dnsseed.masternode.io"));

        // Testnet Bullet addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Bullet script addresses start with '8' or '9'
...
public:
    CRegTestParams() {
        ...
        // Regtest Bullet addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Bullet script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
